    ...
    upgrades: {
        ...
        13: {
            ...
            effect(){
                ...
                if(v13.gte(new Decimal("1.8e308"))) v13 = v13.mul(new Decimal("1.8e308")).pow(0.5)
                return v13
            },
            effectDisplay(){
...
addLayer("i", {
    ...
    gainMult() {
        pmult = new Decimal(1)
        if (hasIUpg(13)) pmult = pmult.mul(getIUpgEff(13))
        if (hasIUpg(23)) pmult = pmult.mul(getIUpgEff(23))
        return pmult
    },
    gainExp() {
        return new Decimal(1)
